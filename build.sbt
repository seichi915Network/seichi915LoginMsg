...
ThisBuild / description := "seichi915Network ログイン・ログアウトメッセージ変更プラグイン"
...
lazy val root = (project in file("."))
  .settings(
    name := "seichi915LoginMsg",
    assemblyOutputPath in assembly := baseDirectory.value / "target" / "build" / s"seichi915LoginMsg-${version.value}.jar"
  )